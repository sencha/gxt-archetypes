...
import ${package}.theme.theme2.client.base.field.Css3CheckBoxAppearance;
...
public class TritonCheckBoxAppearance extends Css3CheckBoxAppearance {
  ...
  public interface TritonCheckBoxResources extends Css3CheckBoxResources {
    ...
    @Source({"${packageInPathFormat}/theme/theme2/client/base/field/Css3ValueBaseField.gss",
            "${packageInPathFormat}/theme/theme2/client/base/field/Css3CheckBox.gss", "TritonCheckBox.gss"})

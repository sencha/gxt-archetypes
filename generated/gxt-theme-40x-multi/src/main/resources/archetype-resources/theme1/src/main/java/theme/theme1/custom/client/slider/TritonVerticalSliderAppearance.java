...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.theme.theme1.custom.client.slider;

import com.google.gwt.core.client.GWT;
import com.google.gwt.resources.client.ImageResource;
import com.google.gwt.resources.client.ImageResource.ImageOptions;

import ${package}.theme.theme1.client.base.slider.Css3VerticalSliderAppearance;
...
public class TritonVerticalSliderAppearance extends Css3VerticalSliderAppearance {
  ...
  public interface TritonVerticalSliderResources extends Css3VerticalSliderResources {
    ...
    @Source({"${packageInPathFormat}/theme/theme1/client/base/slider/Css3HorizontalSlider.gss",
            "${packageInPathFormat}/theme/theme1/client/base/slider/Css3VerticalSlider.gss",
            "TritonSlider.gss", 

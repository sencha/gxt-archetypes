...
public class TritonButtonCellToolBarAppearance<M> extends TritonButtonCellAppearance<M> {
  ...
  public interface TritonButtonCellResources extends Css3ButtonResources {
    ...
    @Override
    @Source({"${packageInPathFormat}/theme/theme1/client/base/button/Css3ButtonCell.gss",
            "${packageInPathFormat}/theme/theme1/client/base/button/Css3ButtonCellToolBar.gss", "TritonButtonCellToolBar.gss"})
